...
export default function Button({
  ...
  const baseClasses =
    "flex items-center justify-center text-center transition-all backdrop-blur-[100px] gap-[10px] whitespace-nowrap cursor-pointer";

  const variantClasses = {
    // Default variant (transparent with border)
    default:
      "border border-[var(--default)] text-[var(--default)] hover:bg-[var(--primary)] py-4 px-[105px]",

    // Filled variant (primary color background)
    filled:
      "border border-[var(--primary)] bg-[var(--primary)] text-[var(--default)] py-4 px-[105px]",

    // Outlined variant (transparent with primary color border)
    outlined:
      "border border-[var(--primary)] bg-[var(--default)-05] text-[var(--primary)] hover:bg-[var(--primary)] hover:text-[var(--default)] py-4 px-[105px]",

    // OutlinedDark variant (for dark backgrounds)
    outlinedDark:
      "border border-[var(--default)] bg-[var(--default)-05] text-[var(--default)] hover:bg-[var(--default-05)] py-4 px-[105px]",
      ...
      {isCTA && (
        ...
        >
          <path
            d="M1 1L5 5L9 1"
            stroke={
              variant === "outlinedDark" ? "var(--default)" : "var(--primary)"
            }
            strokeWidth="1.5"
            strokeLinecap="round"
